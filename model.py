...
class EfficientNetModel(nn.Module):
    def __init__(self, num_classes=2, pretrained=True):
        ...
        self.effnet = EfficientNet.from_pretrained('efficientnet-b0') if pretrained else EfficientNet.from_name('efficientnet-b0')
        
        # 替换输入层以适应音频特征（假设输入通道为1）
        self.effnet._conv_stem = nn.Conv2d(1, 32, kernel_size=3, stride=2, padding=1, bias=False)
